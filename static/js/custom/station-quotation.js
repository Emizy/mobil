$(document).ready(function () {
    ...
    let station_quotation_tbl = $("#station_quotation_tbl").DataTable({
        ...
        "paging": true,
        ajax: {
            "url": '/station/quotation/',
            'type': 'POST',
            'data': {
                'csrfmiddlewaretoken': $("[name=csrfmiddlewaretoken]").val(),
                columnsDef: ['invoice_number', 'invoice_date', 'due_date', 'amount', 'status', 'created_by', 'created_at', ''],
            }
        },
        columns: [
